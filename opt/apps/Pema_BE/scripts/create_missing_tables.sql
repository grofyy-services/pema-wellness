-- Pema Wellness - Create missing database tables
-- This script should be run on the production VPS to complete the schema.
...
-- Create indexes for performance for new tables
