...
export default function Wellness() {
  ...
  const crumbs = [
    { label: 'Home', href: '/' },
    { label: 'Wellness journey', href: ROUTES.wellnessProgram },
    {
  ...
  return (
    <div className=' max-w-[1360px] m-auto py-6 '>
      ...
      <section id='overview'>
        ...
        {programData.what_brings_you_here && (
          <div className='mt-12 md:px-0 px-4 md:mt-20 md:grid md:grid-cols-[66%_33%] gap-5 w-full'>
            <div className='text-[28px]  md:hidden block text-pemaBlue text-center font-ivyOra mb-3'>
              {programData.what_brings_you_here.heading}
            </div>
            <div className='relative w-full md:h-[517] h-[350] overflow-hidden md:mb-3 mb-3'>
              <ImageWithShimmer
                src={programData.what_brings_you_here.imgMobile}
                alt='prepare'
                fill
                className='object-cover md:hidden block'
              />
              <ImageWithShimmer
                src={programData.what_brings_you_here.imgWeb}
                alt='prepare'
                fill
            ...
            <div className='md:mt-9'>
              {' '}
              <div className='text-[28px] md:block hidden md:text-[40px] text-pemaBlue font-ivyOra md:mb-6'>
                {programData.what_brings_you_here.heading}
              </div>
              {programData.what_brings_you_here.pointers.map((item, index) => {
                return (
                  <div key={item} className='flex flex-row items-start gap-2 mt-3'>
                    <Image
        ...
        <div className='mt-12 md:mt-20 md:px-0 px-4'>
          <div className=' md:grid lg:grid-cols-[66%_33%] md:grid-rows-1 md:gap-0 h-max mt-6'>
            ...
            <div className='flex flex-col h-fit md:mx-5 mb-3 md:sticky md:top-24'>
              <div className='md:mt-9 mt-6'>
                ...
                <div className='mt-2 '>
                  ...
                  <div className=' text-base md:text-xl text-slateGray md:mt-2 leading-[120%]'>
                    {programData.three_img_section.sub_text_1} <br />
                    {programData.three_img_section.sub_text_2} <br />
                    {programData.three_img_section.sub_text_3}{' '}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className='md:hidden bg-sunkbakedShell w-full flex items-center flex-row justify-center text-slateGray font-ivyOra h-12 mt-12'>
          <Check /> Naturopathic physicians with 30+ years experience
        </div>
      </section>
      ...
      <div className='mt-12 md:mt-20 m-auto md:px-0 px-4 mx-auto'>
        <div className='p-4 md:p-9 bg-softSand'>
          <div className='flex flex-col-reverse md:grid md:grid-cols-[33%_66%] md:gap-5 w-full'>
            ...
            <div className='text-[24px] md:text-[32px] text-pemaBlue md:hidden block text-center font-ivyOra mb-3'>
              {programData.whats_included.title}{' '}
            </div>
          </div>
        </div>
