              ...
              >
                <div className='border-[0.5px] border-[#39798FB2]'>
                  ...
                  <ImageWithShimmer
                    ...
                    src={doc.mobileImage}
                    alt={doc.name}
                    className={`w-full ${isActive ? 'block' : 'hidden'} h-[250px]! md:h-[308px]! object-cover!`}
                    preload={i === 0}
                  />
                  <div className='px-2 py-3 md:py-4 md:px-4'>
                    <h3 className='text-base md:text-2xl text-pemaBlue font-ivyOra'>{doc.name}</h3>
                    <p className='text-sm md:text-xl text-pemaBlue mb-2'>{doc.title}</p>

                    {isActive && (
                      <>
                        <p className='hidden md:block  md:text-xl text-slateGray my-3 '>
                          {doc.about}
                        </p>
                        ...
                        <p className='md:bg-[#F7F2EE] text-slateGray text-sm md:text-xl md:p-3 w-full whitespace-break-spaces'>
                          {doc.quote}
                        </p>
                      </>
                    )}
